...
export function MyProjectsSection({ t }: MyProjectsSectionProps) {
  ...
  return (
    <section id="my-projects" className="relative isolate overflow-hidden px-4 py-14 sm:px-6 sm:py-20">
      ...
      <div
        className="absolute inset-0 opacity-0 dark:opacity-100 transition-opacity duration-500 bg-[linear-gradient(180deg,rgba(2,6,23,0.25),rgba(2,6,23,0.9)),linear-gradient(115deg,rgba(34,211,238,0.1),transparent_36%,rgba(47,226,138,0.1)_74%,transparent)]"
        aria-hidden="true"
      />
      <div
